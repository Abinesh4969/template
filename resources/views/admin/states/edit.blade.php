...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    ...
    <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
        <li class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  
            ...
            <a href="{{ route('states.index') }}" class="text-slate-400 dark:text-zink-200">State</a>
        </li>
        ...
        <div class="card">
            <div class="card-header">
                <div class="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-700">
                    <h2 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Edit State</h2>
                    <a href="{{ url()->previous() }}" 
            ...
            <div class="card-body">
                <form class="edit-state-form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="space-y-2 w-full">
                            <div class="flex items-center">
                                <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                    ...
                                    <label for="editStatus" class="block h-5 overflow-hidden duration-300 ease-linear border rounded-full cursor-pointer border-slate-200 dark:border-zink-500 bg-slate-200 dark:bg-zink-600 peer-checked/published:bg-custom-500 peer-checked/published:border-custom-500"></label>
                                </div>
                                <label for="editStatus" class="inline-block text-base font-medium cursor-pointer">Status</label>
                            </div>
                        </div>
                    </div>
