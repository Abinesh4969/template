        ...
        <div class="col-md-6 col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center position-relative">
                    ...
                    <h4 class="card-title position-absolute top-50 start-50 translate-middle">Add districts</h4>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="districts_name" name="districts_name" class="form-control" placeholder="Enter districts name">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check form-switch">
                                            <input type="checkbox" id="addStatus" class="form-check-input" checked>
    ...
    $('.add-new-data').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire('Success!', 'districts has been added successfully.', 'success')
                .then(() => {
